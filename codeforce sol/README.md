...
This folder contains **Codeforces problem solutions** in multiple languages.  
Contributors can add solutions for problems from [Codeforces](https://codeforces.com/) following the guidelines below.
...
cpp/Codeforces/<Problem_Name>.cpp
java/Codeforces/<Problem_Name>.java
python/Codeforces/<Problem_Name>.py
...
Add your solution to the Codeforces/ folder for your language
...
Contest round or number (if applicable)
...
Copy code
git add .
git commit -m "Added <Problem Name> solution in <Language> with explanation"
Push your branch:
...
Provide a clear PR title and description including the problem link and explanation summary
...
Explanation is clear and well-written
