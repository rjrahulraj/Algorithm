...
This folder contains **GeeksforGeeks problem solutions** in multiple languages.  
Contributors can add solutions for problems from [GeeksforGeeks](https://www.geeksforgeeks.org/) following the guidelines below.
...
cpp/GFG/<Problem_Name>.cpp
java/GFG/<Problem_Name>.java
python/GFG/<Problem_Name>.py
...
Add your solution to the GFG/ folder for your language
