# 🍽️ CodeChef Solutions

This folder contains **CodeChef problem solutions** in multiple languages.  
Contributors can add solutions for problems from [CodeChef](https://www.codechef.com/) following the guidelines below.
...
cpp/CodeChef/<Problem_Name>.cpp
java/CodeChef/<Problem_Name>.java
python/CodeChef/<Problem_Name>.py
...
Add your solution to the CodeChef/ folder for your language
